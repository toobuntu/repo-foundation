...
description: >-
  ...
  titled draft at .ai/scratchpad/issue-<slug>.md (the maintainer files it), plus the search
  terms for checking whether it is already known. Do not open the issue; drafting and filing
  are separate steps.
---

# Upstream issue drafts

The maintainer files the issue. This skill produces the text and the prior-art search terms. Write the draft to `.ai/scratchpad/issue-<slug>.md` — the `issue-` prefix first, so drafts group together in a directory listing — and delete it once it has been filed.
