...
**Authoritative design doc:** [`docs/handoff/archive/w1-buildout-plan.md`](./w1-buildout-plan.md) — read it first. It holds the inventory, the per-file canonical map, the locked organization + sync design, the ADR policy, and the phased roadmap.
